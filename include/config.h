...
#define DEFAULT_MYSQL_HOME "/data/mysql/base"
#define SHAREDIR "/data/mysql/base/share"
#define DEFAULT_BASEDIR "/data/mysql/base"
#define MYSQL_DATADIR "/data/mysql/base/data"
#define MYSQL_KEYRINGDIR "/data/mysql/base/keyring"
#define DEFAULT_CHARSET_HOME "/data/mysql/base"
#define PLUGINDIR "/data/mysql/base/lib/plugin"
#define DEFAULT_SYSCONFDIR "/data/mysql/base/etc"
...
#define INSTALL_PLUGINTESTDIR "/data/mysql-server/plugin/x/tests"
